...
class PhraseScene {
  ...
  static const List<PhraseScene> all = [
    PhraseScene(
      ...
      descriptionJa: '安全・作業指示のフレーズ',
      descriptionId: 'Frasa keselamatan dan instruksi kerja',
      icon: '🏭',
      categoryIds: [2, 3],
    ),
    PhraseScene(
    ...
    PhraseScene(
      key: 'medical',
      nameJa: '病院・体調',
      nameId: 'Rumah Sakit & Kondisi Tubuh',
      descriptionJa: '体調・けが・受診のフレーズ',
      descriptionId: 'Frasa kondisi tubuh, cedera, dan berobat',
      icon: '🏥',
      categoryIds: [7],
    ),
    PhraseScene(
      key: 'emergency',
      nameJa: '緊急・防災',
      nameId: 'Darurat & Bencana',
      descriptionJa: '地震・火事・けがなど緊急時のフレーズ',
      descriptionId: 'Frasa darurat: gempa, kebakaran, cedera',
      icon: '🚨',
      categoryIds: [5],
    ),
    PhraseScene(
