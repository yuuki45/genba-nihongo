...
### JLPT N3/N2対策パックの内容（quizzes.json data_version: 2）
- 無料: N3クイズ100問（従来どおり）
- 有料（pack_id: jlpt_n3n2）: N3対策50問（id 101-150）+ N2対策50問（id 151-200）
- 現場文脈の出題（〜ざるを得ない、〜かねない、是正・手配・稼働などの実務語彙）
- ホームに「N2クイズに挑戦」カード（JIS青）。未購入時はロック表示→ストアへ誘導
- N3クイズは無料100問+解錠時150問に自動拡大（randomQuizzesProviderの解錠フィルタ）
